...
Path3D testCage = new(Pieces: [
    ...
    new Line3D( new(-arcRadius*2, 0, arcRadius), new(-arcRadius*2, 0, len-arcRadius), IsSelected: true),
    ...
    new Line3D( new(0, 0, len-arcRadius), new(0, 0, len-arcRadius*3), IsDependent: true),
...
Path3D testOverlap = new(Pieces: [
    new Line3D(new(0,0,len-len*0.3f), new(0,0,len-arcRadius), IsSelected : true), //Start overlap
    ...
    new Arc3D(Start: new(len, 0, arcRadius), End: new(len-arcRadius, 0, 0), Center: new(len-arcRadius, 0, arcRadius), Axis: outVec, SweepDeg: -90),
    new Line3D(new(len-arcRadius, 0, 0), new(arcRadius, 0, 0), IsDependent: true),
    ...
    new Line3D(new(0,0,arcRadius), new(0,0,len-arcRadius)),
    new Arc3D(Start: new(0,0,len-arcRadius), End: new(arcRadius,0,len), Center: new(arcRadius, 0, len-arcRadius), Axis: outVec, SweepDeg: -90),
    new Line3D(new(arcRadius,0,len), new(len*0.3f,0,len), IsSelected: true)//End overlap
],
Diameter: 10
);

Path3D testOddAngles = new(Pieces: [
    new Line3D(new(0,0,len*1.5f), new(len,0,0), IsSelected: true),
